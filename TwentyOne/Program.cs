    ...
    class Program
    {
        ...
        private static void UpdateDbWithException(Exception ex)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                connection.Open();
                command.ExecuteNonQuery();//this is throwing an error due to null trying to be inserted into Id "System.Data.SqlClient.SqlException: 'Cannot insert the value NULL into column 'Id', table 'TwentyOneGame.dbo.Exceptions'; column does not allow nulls. INSERT fails. The statement has been terminated.'"
                connection.Close();
            }
        }
